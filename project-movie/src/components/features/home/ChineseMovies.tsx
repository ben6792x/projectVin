// src/components/features/home/ChineseMovies.tsx
'use client';
...
export default function ChineseMovies() {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                const data = await movieService.getChineseMovies();
                // Lấy 8 phim đầu tiên
    ...
    return (
        <div className="container mx-auto px-4 mt-8">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-blue-500">Phim Trung Quốc</h2>
                <Link
                    href="/hoat-hinh-trung-quoc"
